...
pic30-as  --defsym YMEM_ERRATA=1 --defsym PSV_ERRATA=1 --defsym __dsPIC33E=1 -p generic-16dsp-ep -I ./inc -a=./obj/cplxFft32b.lst -o ./obj/cplxFft32b.obj ./asm/cplxFft32b2.s
pic30-as  --defsym YMEM_ERRATA=1 --defsym PSV_ERRATA=1 --defsym __dsPIC33E=1 -p generic-16dsp-ep -I ./inc -a=./obj/realFft32b.lst -o ./obj/realFft32b.obj ./asm/realFft32b2.s
